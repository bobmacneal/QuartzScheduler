...
intellisense.annotate(jQuery, {
  ...
  'param': function() {
    /// <signature>
    ///   <summary>CreateOrder a serialized representation of an array or object, suitable for use in a URL query string or Ajax request.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'clone': function() {
    /// <signature>
    ///   <summary>CreateOrder a deep copy of the set of matched elements.</summary>
